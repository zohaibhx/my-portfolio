...
st.write("* Supported the end-to-end product lifecycle for an IoT-based Worker Welfare & Safety System for 500+ site laborers. [cite: 28]")
st.write("* Developed Automated Flagging Logic reducing safety incidents by 35%. [cite: 29]")
st.write("* Managed delivery of a 3D Reality Capture solution, improving clash detection accuracy by 22%. [cite: 30]")

st.subheader("Business Analyst | Najah Media [cite: 53]")
st.write("* Analyzed cross-platform data for 12+ SMMA clients to increase ROAS. [cite: 54]")
st.write("* Developed performance dashboards using Tableau and Excel, automating 70% of reporting. [cite: 55]")
st.write("* Conducted deep-dive funnel analysis and A/B testing to drive a 1.5% increase in CTR. [cite: 56, 58]")

st.subheader("Operations Analyst | AllMilez [cite: 31]")
st.write("* Identified operational bottlenecks and implemented targeted workflow solutions. [cite: 32]")
st.write("* Leveraged analytics to track performance and support streamlined business processes. [cite: 33]")
